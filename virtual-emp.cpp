// c++ program to demonstrate the use of a virtual function 
...
class HourlyEmployee: public Employee {
    private:
        double hourly_wage;
    public:
        HourlyEmployee(string fname, string lname, double wage_per_hr): Employee(fname, lname), hourly_wage(wage_per_hr){
        }

    // override the base class function and provide proper implementation 
...
int main() {    
    ...
    // vector to store Employee* pointing to the derived class objects 
    vector<Employee*> employees{
        new HourlyEmployee("John", "Doe", 13.5), 
        new RegularEmployee("Samson", "McDonald", 3000.7)
    };
